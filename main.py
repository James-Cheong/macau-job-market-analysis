...
with st.spinner('Fetching data...'):
    ...
    st.dataframe(filtered_df.style.format({'mid_salary': '{:.2f}'}))


col1, col2 = st.columns(2)

with col1:
    st.subheader("澳門前15工種平均薪金(不含佣金)")
